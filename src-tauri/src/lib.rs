...
pub fn run() {
    let builder = tauri_specta::Builder::<tauri::Wry>::new()
        .commands(tauri_specta::collect_commands![
            ...
            notes::get_page_versions,
            notes::get_version,
            notes::restore_version,
            notes::compare_versions,
            notes::compare_version_with_current,
            notes::save_manual_version,
            notes::get_sectioned_diff,
            notes::delete_version,
            chat::create_chat,
            chat::list_chats,
            chat::get_messages,
            chat::delete_chat,
            ...
            search::structured_search,
            search::validate_query,
            search::get_saved_queries,
            search::save_query,
            search::delete_query,
            search::execute_saved_query,
            search::rename_query,
            search::get_popular_queries,
            search::get_recent_queries,
            search::structured_search_detailed,
